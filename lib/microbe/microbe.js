 ...
 */
module.exports.microbe = function(staticPath, callbackurl, port, redisConfig, fbConfig){
	...
	*/
	...
	/* Security restictive middleware - requires the user has connected to a socket and therefore serialised the user cookie to the request headers
